...
public class DailyStockPriceTest extends TestCase {
    ...
    protected void setUp() {
        ...
        dm1.marketCap = 1000;
        dm1.stockNumber = 100;
        dm1.tradingVolume = (long) 200;
        dm1.previousTradingVolume = (long) 300;
        dm2.marketCap = 2000;
        dm2.stockNumber = 200;
        dm2.tradingVolume = (long) 200;
        dm2.previousTradingVolume = (long) 100;
    ...
    public void testSelectLatests() {
        ...
        dsp1_1.marketCap = 100;
        dsp1_1.stockNumber = 10;
        dsp1_1.tradingVolume = (long) 100;
        dsp1_1.previousTradingVolume = (long) 1000;
        dsp1_2.marketCap = 1000;
        dsp1_2.stockNumber = -10;
        dsp1_2.tradingVolume = (long) 200;
        dsp1_2.previousTradingVolume = (long) 300;
        dsp2_2.marketCap = 400;
        dsp2_2.stockNumber = 30;
        dsp2_2.tradingVolume = (long) 400;
        dsp2_2.previousTradingVolume = (long) 500;
    ...
    public void testSelectPasts() {
        ...
        dsp1.marketCap = 100;
        dsp1.stockNumber = 10;
        dsp1.tradingVolume = (long) 900000;
        dsp1.previousTradingVolume = (long) 1;
        cdsp1.marketCap = 300;
        cdsp1.stockNumber = 10;
        cdsp1.tradingVolume = (long) 900000;
        cdsp1.previousTradingVolume = (long) 1;
        dsp2.marketCap = 1000;
        dsp2.stockNumber = -10;
        dsp2.tradingVolume = (long) 1;
        dsp2.previousTradingVolume = (long) 9000000;
        dsp3.marketCap = 400;
        dsp3.stockNumber = 30;
        dsp3.tradingVolume = (long) 10000;
        dsp3.previousTradingVolume = (long) 10000;
        dsp4.marketCap = 500;
        dsp4.stockNumber = 30;
        dsp4.tradingVolume = (long) 10;
        dsp4.previousTradingVolume = (long) 100;
        dsp5.marketCap = 600;
        dsp5.stockNumber = 30;
        dsp5.tradingVolume = (long) 100;
        dsp5.previousTradingVolume = (long) 1000;
        Map<String, DailyStockPrice> dsp_map = new HashMap<String, DailyStockPrice>();
