...
/**
 * 個別企業のニュースコレクター.
 * 企業名：【6862】ミナトホールディングス
 * @author toru1055
 */
public class CompanyNewsCollector6862
  extends BaseCompanyNewsCollector
  implements CompanyNewsCollector {
  private static final int stockId = 6862;
  private static final String IR_URL = "http://www.minato.co.jp/jp/news/";
  ...
  public void parseIRList(List<CompanyNews> newsList)
    ...
    Elements dtList = doc.select("#main > dl > dt");
    Elements ddList = doc.select("#main > dl > dd");
