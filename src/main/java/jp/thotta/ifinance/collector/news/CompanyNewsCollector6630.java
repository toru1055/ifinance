 ...
 * @author toru1055
 */
public class CompanyNewsCollector6630
  extends BaseCompanyNewsCollector
  implements CompanyNewsCollector {
  private static final int stockId = 6630;
  private static final String IR_URL = "http://v4.eir-parts.net/V4Public/EIR/6630/ja/announcement/announcement_11.xml";
  private static final String PR_URL = "http://www.ya-man.com/corporate/";
  ...
  public void parsePRList(List<CompanyNews> newsList)
    ...
    Elements dtList = doc.select("div.body > dl > dt");
    Elements ddList = doc.select("div.body > dl > dd");
