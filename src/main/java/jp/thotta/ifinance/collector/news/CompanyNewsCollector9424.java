 ...
 * @author toru1055
 */
public class CompanyNewsCollector9424
        extends BaseCompanyNewsCollector
        implements CompanyNewsCollector {
    private static final int stockId = 9424;
    private static final String IR_URL = "";
    private static final String PR_URL = "http://www.j-com.co.jp/";
    ...
    public void parsePRList(List<CompanyNews> newsList)
        ...
        Elements elements = doc.select("div > div > dl");
