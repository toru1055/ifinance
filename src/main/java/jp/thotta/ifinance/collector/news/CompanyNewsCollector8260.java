 ...
 * @author toru1055
 */
public class CompanyNewsCollector8260
        extends BaseCompanyNewsCollector
        implements CompanyNewsCollector {
    private static final int stockId = 8260;
    private static final String IR_URL = "http://corp.izutsuya.co.jp/";
    ...
    public void parseIRList(List<CompanyNews> newsList)
        ...
        Elements dtList = doc.select("#content > div > dl > dt");
        Elements ddList = doc.select("#content > div > dl > dd");
