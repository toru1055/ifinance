 ...
 * @author toru1055
 */
public class CompanyNewsCollector4316
        extends BaseCompanyNewsCollector
        implements CompanyNewsCollector {
    private static final int stockId = 4316;
    private static final String IR_URL = "";
    private static final String PR_URL = "http://www.bemap.co.jp/";
    ...
    public void parsePRList(List<CompanyNews> newsList)
        ...
        Elements elements = doc.select("#top_press > dl");
