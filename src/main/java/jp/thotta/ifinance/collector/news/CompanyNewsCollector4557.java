 ...
 * @author toru1055
 */
public class CompanyNewsCollector4557
        extends BaseCompanyNewsCollector
        implements CompanyNewsCollector {
    private static final int stockId = 4557;
    private static final String IR_URL = "http://v4.eir-parts.net/V4Public/EIR/4557/ja/announcement/announcement_2.xml";
    private static final String PR_URL = "http://www.mbl.co.jp/news/";
    ...
    public void parsePRList(List<CompanyNews> newsList)
        ...
        Elements dtList = doc.select("#newsList > dl > dt");
        Elements ddList = doc.select("#newsList > dl > dd");
