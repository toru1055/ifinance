...
/**
 * 個別企業のニュースコレクター.
 * 企業名：【4847】インテリジェント　ウェイブ
 *
 * @author toru1055
 */
public class CompanyNewsCollector4847
        extends BaseCompanyNewsCollector
        implements CompanyNewsCollector {
    private static final int stockId = 4847;
    private static final String IR_URL = "AS00585";
    private static final String PR_URL = "http://www.iwi.co.jp/";
    ...
    public void parsePRList(List<CompanyNews> newsList)
        ...
        Elements elements = doc.select("#contents26 > div > article");
