 ...
 * @author toru1055
 */
public class CompanyNewsCollector4570
  extends BaseCompanyNewsCollector
  implements CompanyNewsCollector {
  private static final int stockId = 4570;
  private static final String IR_URL = "";
  private static final String PR_URL = "http://www.ibl-japan.co.jp/news/";
  ...
  public void parsePRList(List<CompanyNews> newsList)
    ...
    Elements elements = doc.select("#tab1 > div.newProducts.v1.clearFix > dl");
