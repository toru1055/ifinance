 ...
 * @author toru1055
 */
public class CompanyNewsCollector3692
        extends BaseCompanyNewsCollector
        implements CompanyNewsCollector {
    private static final int stockId = 3692;
    private static final String IR_URL = "";
    private static final String PR_URL = "http://www.ffri.jp/cgi-bin/news_index.cgi";
    ...
    public void parsePRList(List<CompanyNews> newsList)
        ...
        Elements dtList = doc.select("#list > div.date");
        Elements ddList = doc.select("#list > div.report");
