 ...
 * @author toru1055
 */
public class CompanyNewsCollector8101
  extends BaseCompanyNewsCollector
  implements CompanyNewsCollector {
  private static final int stockId = 8101;
  private static final String IR_URL = "http://www.gsi.co.jp/";
  ...
  public void parseIRList(List<CompanyNews> newsList)
    ...
    Elements dtList = doc.select("#top-content-L > dl > dt");
    Elements ddList = doc.select("#top-content-L > dl > dd");
