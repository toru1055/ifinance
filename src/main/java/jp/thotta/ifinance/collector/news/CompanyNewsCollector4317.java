 ...
 * @author toru1055
 */
public class CompanyNewsCollector4317
        extends BaseCompanyNewsCollector
        implements CompanyNewsCollector {
    private static final int stockId = 4317;
    private static final String IR_URL = "http://www.ray.co.jp/";
    ...
    public void parseIRList(List<CompanyNews> newsList)
        ...
        Elements dtList = doc.select("#contents > div.unit-home-news > dt");
        Elements ddList = doc.select("#contents > div.unit-home-news > dd");
