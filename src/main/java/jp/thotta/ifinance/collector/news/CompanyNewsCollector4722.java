...
/**
 * 個別企業のニュースコレクター.
 * 企業名：【4722】フューチャーアーキテクト
 * @author toru1055
 */
public class CompanyNewsCollector4722
  extends BaseCompanyNewsCollector
  implements CompanyNewsCollector {
  private static final int stockId = 4722;
  private static final String IR_URL = "http://www.future.co.jp/";
  ...
  public void parseIRList(List<CompanyNews> newsList)
    ...
    Elements dtList = doc.select("#whatsnew > dl > dt");
    Elements ddList = doc.select("#whatsnew > dl > dd");
