 ...
 * @author toru1055
 */
public class CompanyNewsCollector4202
        extends BaseCompanyNewsCollector
        implements CompanyNewsCollector {
    private static final int stockId = 4202;
    private static final String IR_URL = "";
    private static final String PR_URL = "http://www.daicel.com/news/index.php";
    ...
    public void parsePRList(List<CompanyNews> newsList)
        ...
        Elements elements = doc.select("#waku > div > dl");
