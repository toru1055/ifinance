 ...
 * @author toru1055
 */
public class CompanyNewsCollector6323
  extends BaseCompanyNewsCollector
  implements CompanyNewsCollector {
  private static final int stockId = 6323;
  private static final String IR_URL = "http://www.rorze.com/";
  ...
  public void parseIRList(List<CompanyNews> newsList)
    ...
    Elements dtList = doc.select("#presslist > div > div > dl > dt");
    Elements ddList = doc.select("#presslist > div > div > dl > dd.pSummery");
