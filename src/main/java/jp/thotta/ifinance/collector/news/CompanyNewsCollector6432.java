 ...
 * @author toru1055
 */
public class CompanyNewsCollector6432
  extends BaseCompanyNewsCollector
  implements CompanyNewsCollector {
  private static final int stockId = 6432;
  private static final String IR_URL = "http://www.takeuchi-mfg.co.jp/ir/release.xml";
  private static final String PR_URL = "http://www.takeuchi-mfg.co.jp/site/new_list.php";
  ...
  public void parsePRList(List<CompanyNews> newsList)
    ...
    Elements dtList = doc.select("#sub_contents > dt");
    Elements ddList = doc.select("#sub_contents > dd");
